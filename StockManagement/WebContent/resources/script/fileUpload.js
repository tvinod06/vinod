...
function uploadFile(purpose){
	...
	if(document.getElementById('purpose') != undefined){
		if(document.getElementById('purpose').value != ''){
			...
			alert("Enter Purpose / Name.");
			document.getElementById('file').value='';
			return;
		}
	}else if(purpose != undefined){
		oMyForm.append("purpose", purpose);	
	}
	if(document.getElementById('category') != undefined){
		oMyForm.append("category", document.getElementById('category').value);
	}
	...
	jQuery.ajax({
	    ...
	    success: function(data){
	    	...
	    	if(jsonData.docId != null && jsonData.docId != ''){
	    		...
	    		alert("Could not upload file. File size should be Less than 16MB.");
	    	}
	    }
	});
}