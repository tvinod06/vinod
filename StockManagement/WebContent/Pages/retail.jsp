...
<body>
	<form id="retailForm" name="retailForm" action="submitRetail"
		...
		<div class="container">
			...
			<br><br><br><br><br><br>
				<div class="form-group">
					...
					<div class="form-group">
						<div>
							<input type="text" name="totalRetailAmnt" id="totalRetailAmnt"
								class="form-control name-field" 
								placeholder="Total Retail Amount" readonly="true">
						</div>
					</div>
					<div class="form-group">
						<div>
				...
				<div class="form-group">
					<button type="button" class="btn btn-primary"
						onclick="submitretailForm()">Submit</button>
				</div>
			</div>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function addTableRow() {
			...
			if (map.hasOwnProperty(c.value)) {
				...
				document.getElementById("totalRetailAmnt").value = +(document
						.getElementById("totalRetailAmnt").value)
						+ +(document.getElementById("totalAmount").value);
